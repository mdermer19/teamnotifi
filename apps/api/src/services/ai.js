...
const STATE_CONFIGS = {
  ...
  CONFIRM_DATE: {
    ...
    description: 'TODAY or TOMORROW are keywords. DATE means they gave a specific date like "Monday", "June 20", "next week" — extract the most likely date as MM/DD. If they say a range like "the next two days", "a few days", or "a couple days", return TODAY (assume the absence starts now). UNKNOWN if truly unclear.',
  },
  SELECT_REASON: {
